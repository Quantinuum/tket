...
TKET_EXPORT Circuit
CU3_using_CX(const Expr &theta, const Expr &phi, const Expr &lambda);
 ...
 */
TKET_EXPORT Circuit
TK2_using_3xCX(const Expr &alpha, const Expr &beta, const Expr &gamma);
 ...
 */
TKET_EXPORT Circuit
normalised_TK2_using_CX(const Expr &alpha, const Expr &beta, const Expr &gamma);
 ...
 */
TKET_EXPORT Circuit
TK2_using_CX(const Expr &alpha, const Expr &beta, const Expr &gamma);
 ...
 */
TKET_EXPORT Circuit
TK2_using_CX_and_swap(const Expr &alpha, const Expr &beta, const Expr &gamma);
 ...
 */
TKET_EXPORT Circuit
approx_TK2_using_2xZZPhase(const Expr &alpha, const Expr &beta);
 ...
 */
TKET_EXPORT Circuit
TK2_using_ZZPhase(const Expr &alpha, const Expr &beta, const Expr &gamma);
/**
 * @brief Equivalent to TK2(α, β, γ)  up to a wire swap that is encoded in
 * the implicit qubit permutation of the Circuit with minimal number of
 * ZZPhase gates.
 ...
 */
TKET_EXPORT Circuit
TK2_using_TK2_or_swap(const Expr &alpha, const Expr &beta, const Expr &gamma);

/** Just a TK2(α, β, γ) gate */
TKET_EXPORT Circuit
TK2_using_TK2(const Expr &alpha, const Expr &beta, const Expr &gamma);
 ...
 */
TKET_EXPORT Circuit
TK2_using_ZZMax(const Expr &alpha, const Expr &beta, const Expr &gamma);
...
TKET_EXPORT Circuit
TK2_using_ISWAPMax(const Expr &alpha, const Expr &beta, const Expr &gamma);
...
TKET_EXPORT Circuit
AAMS_using_TK2(const Expr &theta, const Expr &phi0, const Expr &phi1);

/** Equivalent to AAMS, using CX, Rz and U3 gates */
TKET_EXPORT Circuit
AAMS_using_CX(const Expr &theta, const Expr &phi0, const Expr &phi1);
...
TKET_EXPORT Circuit
tk1_to_PhasedXRz(const Expr &alpha, const Expr &beta, const Expr &gamma);

/** converts a TK1 gate to a circuit using PhasedX gates */
TKET_EXPORT Circuit
tk1_to_PhasedX(const Expr &alpha, const Expr &beta, const Expr &gamma);

/** Equivalent to TK1, using Rz and Rx gates */
TKET_EXPORT Circuit
tk1_to_rzrx(const Expr &alpha, const Expr &beta, const Expr &gamma);

/** Equivalent to TK1, using Rx and Ry gates */
TKET_EXPORT Circuit
tk1_to_rxry(const Expr &alpha, const Expr &beta, const Expr &gamma);

/** Equivalent to TK1, using Rz and H gates */
TKET_EXPORT Circuit
tk1_to_rzh(const Expr &alpha, const Expr &beta, const Expr &gamma);

/** Equivalent to TK1, using Rz and SX gates */
TKET_EXPORT Circuit
tk1_to_rzsx(const Expr &alpha, const Expr &beta, const Expr &gamma);

/** Equivalent to TK1, using Rz, X and SX gates */
TKET_EXPORT Circuit
tk1_to_rzxsx(const Expr &alpha, const Expr &beta, const Expr &gamma);

/** Just a TK1(α, β, γ) gate */
TKET_EXPORT Circuit
tk1_to_tk1(const Expr &alpha, const Expr &beta, const Expr &gamma);

/** Equivalent to TK1, using a U3 gate */
TKET_EXPORT Circuit
tk1_to_u3(const Expr &alpha, const Expr &beta, const Expr &gamma);
...
TKET_EXPORT Circuit
TK1_using_GPI(const Expr &alpha, const Expr &beta, const Expr &gamma);

/** Equivalent to TK2, using AAMS, GPI and GPI2 gates */
TKET_EXPORT Circuit
TK2_using_AAMS(const Expr &alpha, const Expr &beta, const Expr &gamma);
