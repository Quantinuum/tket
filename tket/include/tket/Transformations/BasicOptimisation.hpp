...
squash_1qb_to_pqp(const OpType& q, const OpType& p, bool strict = false);
...
TKET_EXPORT Transform
commute_SQ_gates_through_SWAPS(const avg_node_errors_t& node_errors);
TKET_EXPORT Transform
commute_SQ_gates_through_SWAPS(const op_node_errors_t& node_errors);
