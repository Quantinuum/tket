...
The source code will remain on the [Quantinuum github organisation](https://github.com/Quantinuum/) in an archived state. The packages will remain on pypi. There will be no active maintenance of these projects.
```
