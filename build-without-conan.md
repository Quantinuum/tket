...
```
cd ${TMP_DIR}
wget https://github.com/symengine/symengine/archive/refs/tags/v0.15.0.tar.gz
tar xzvf v0.15.0.tar.gz
cd symengine-0.15.0/
mkdir build
cd build
...
```
cd ${TMP_DIR}
wget https://github.com/catchorg/Catch2/archive/refs/tags/v3.15.3.tar.gz
tar xzvf v3.15.3.tar.gz
cd Catch2-3.15.3/
mkdir build
cd build
cmake -DCMAKE_INSTALL_PREFIX=${INSTALL_DIR} ..
...
```
cd ${TMP_DIR}
wget https://github.com/wjakob/nanobind/archive/refs/tags/v3.0.0.tar.gz
