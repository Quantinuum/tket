...
```
cd ${TMP_DIR}
wget -O boost_1_90_0.tar.gz https://sourceforge.net/projects/boost/files/boost/1.90.0/boost_1_90_0.tar.gz/download
...
```
cd ${TMP_DIR}
wget https://github.com/catchorg/Catch2/archive/refs/tags/v3.13.0.tar.gz
tar xzvf v3.13.0.tar.gz
cd Catch2-3.13.0/
mkdir build
cd build
cmake -DCMAKE_INSTALL_PREFIX=${INSTALL_DIR} ..
...
```
cd ${TMP_DIR}
wget https://github.com/wjakob/nanobind/archive/refs/tags/v2.12.0.tar.gz
